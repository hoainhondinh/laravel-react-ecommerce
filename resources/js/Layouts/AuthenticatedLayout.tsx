          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-[#D9C97E] transition">Hướng dẫn mua hàng</a></li>
                <li><a href="#" className="hover:text-[#D9C97E] transition">Chính sách đổi trả</a></li>
                <li><a href="#" className="hover:text-[#D9C97E] transition">Chính sách bảo mật</a></li>
                <li><a href="#" className="hover:text-[#D9C97E] transition">Phương thức thanh toán</a></li>
              </ul>
            </div>

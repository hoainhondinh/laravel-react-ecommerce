...
export default function AuthenticatedLayout({
  ...
  // Ví dụ lấy số lượng thông báo chưa đọc (nếu có)
  const unreadNotifications = usePage().props.unreadNotifications || 0;
  ...
  useEffect(() => {
    ...
    // Thêm class để tạo padding cho bottom nav
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <MobileBottomNav notificationCount={unreadNotifications} />
